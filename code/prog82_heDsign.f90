...
!   READ THE SPECIFIC HEAT CAPACITY OF FLUID, (Btu/hr.ft.oF) : TSHC
!   READ THE FLUID THERMAL CONDUCTIVITY (Btu/ft.h.oF) : TFK
...
GO TO 110
ELSE
!      Using the Mills Correlation for longer tubes
HT = (3.66+((0.065*RET*PRT*(TID/TL))/ &
& (1+0.04*(RET*PRT*(TID/TL)**0.67))))*TFK/TID
ENDIF
