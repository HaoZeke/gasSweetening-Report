...
C   IN THE PROGRAM
C     Adapted by Rohit Goswami from Kayode's Fortran Programs
C   ******************************************************************
C
...
C   READ THE SPECIFIC HEAT CAPACITY OF FLUID, (Btu/hr.ft.oF) : TSHC
C   READ THE FLUID THERMAL CONDUCTIVITY (Btu/ft.h.oF) : TFK
